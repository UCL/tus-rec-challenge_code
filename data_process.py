...
FILENAME_CALIB = 'Path/To/CSV'

# get object names in HDF5 file
DataSet = h5py.File(os.path.join(DATA_DIR,"005","RH_Per_S_PtD.h5"),'r')    
...
plot_scan(labels_four.numpy(),example_scan,os.getcwd()+'/'+"example",step=10)
